                    ...
                    <div class="inside">
                        ...
                        <div class="tab-content" id="accountContent">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <x-image :text="__('static.svg_not_supported')" :unallowed_types="['svg']" :name="'profile_image_id'" :data="isset($driver->profile_image)
                                                ? $driver?->profile_image : old('profile_image_id')"  :multiple="false"></x-image>
                            ...
                            <div class="tab-pane fade {{ session('active_tab') == 'additionalInfo-tab' ? 'show active' : '' }}"
                                ...
                                <div class="form-group row">
                                    <label class="col-md-2" for="is_on_ride">{{ __('taxido::static.drivers.is_on_ride') }}</label>
                                    <div class="col-md-10">
                                        <div class="switch-field form-control">
